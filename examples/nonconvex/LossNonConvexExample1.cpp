...
LossNonConvexExample1::LossNonConvexExample1(const int id, const string& name): LossLayer(id, name){
...
float LossNonConvexExample1::lossCompute(Tensor<float>* pGroundTruth){
