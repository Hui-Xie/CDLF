...
MnistConvNet::MnistConvNet(const string& name, const string& saveDir, MNIST* pMnistData): FeedForwardNet(name, saveDir){
...
void MnistConvNet::build4DConvolutionNet(){
    // it is a good design if all numFilter is odd;
    cout<<"Info: building a 4D convolutional network"<<endl;
    ...
    ConvolutionLayer *conv3 = new ConvolutionLayer(layerID++, "Conv3", getFinalLayer(), {3,3, 3},  7, 1);//output size: 7*3*22*22
    addLayer(conv3);
    ...
    ConvolutionLayer *conv4 = new ConvolutionLayer(layerID++, "Conv4", getFinalLayer(), {7,3,3,3},  1, 1);//output size: 20*20
    addLayer(conv4);
...
void MnistConvNet::build2DConvolutionNet(){
    // it is a good design if all numFilter is odd;
    cout<<"Info: building a 2D convolutional network"<<endl;
