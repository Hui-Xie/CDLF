...
void SegmentGNet::build(){
    ...
    ConvolutionLayer* conv1 = new ConvolutionLayer(30, "G_Conv1", normAfterInput, {3,3, 3}, 31); //output size: 31*118*275*275
    addLayer(conv1);
    ...
    BiasLayer* bias1 = new BiasLayer(40, "G_Bias1", norm1); //output size: 31*118*275*275
    addLayer(bias1);

    BranchLayer* branch1 = new BranchLayer(50, "G_Branch1", bias1); //output size: 31*118*275*275
    addLayer(branch1);
    ...
    ConvolutionLayer* conv3 = new ConvolutionLayer(60, "G_Conv3", norm2, {31,3, 3,3}, 31); //output size: 31*116*273*273
    addLayer(conv3);
    ...
    ConvolutionLayer* conv4 = new ConvolutionLayer(70, "G_Conv4", norm3, {31,3,3,3}, 31); //output size: 31*114*271*271
    addLayer(conv4);
    ...
    ConvolutionLayer* conv5 = new ConvolutionLayer(80, "G_Conv5", norm4, {31,3,3,3}, 31); //output size: 31*112*269*269
    addLayer(conv5);
    ...
    ConvolutionLayer* conv6 = new ConvolutionLayer(90, "G_Conv6", norm5, {31,3,3,3},31); //output size: 31*110*267*267
    addLayer(conv6);
    ...
    ConvolutionLayer* conv7 = new ConvolutionLayer(100, "G_Conv7", norm6, {31,3,3,3}, 3); //output size: 3*108*265*265
    addLayer(conv7);
    ...
    ConvolutionLayer* conv8 = new ConvolutionLayer(110, "G_Conv8", branch1, {31,11,11,11}, 3); //output size: 3*108*265*265
    addLayer(conv8);
