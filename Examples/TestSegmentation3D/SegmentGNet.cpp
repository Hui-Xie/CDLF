...
void SegmentGNet::build(){
    ...
    ConvolutionLayer* conv1 = new ConvolutionLayer(30, "Conv1", normAfterInput, {3,3, 3}, 5); //output size: 5*118*275*275
    addLayer(conv1);
    ...
    BiasLayer* bias1 = new BiasLayer(40, "Bias1", norm1); //output size: 5*118*275*275
    addLayer(bias1);

    BranchLayer* branch1 = new BranchLayer(50, "Branch2", bias1); //output size: 5*118*275*275
    addLayer(branch1);
    ...
    ConvolutionLayer* conv3 = new ConvolutionLayer(60, "Conv3", norm2, {5,5, 5,5}, 21); //output size: 21*114*271*271
    addLayer(conv3);
    ...
    ConvolutionLayer* conv4 = new ConvolutionLayer(70, "Conv4", norm3, {21,7,7,7}, 19); //output size: 19*108*265*265
    addLayer(conv4);
    ...
    ConvolutionLayer* conv5 = new ConvolutionLayer(80, "Conv5", norm4, {19,5,5,5}, 17); //output size: 17*104*261*261
    addLayer(conv5);
    ...
    ConvolutionLayer* conv6 = new ConvolutionLayer(90, "Conv6", norm5, {17,3,3,3},11); //output size: 11*102*259*259
    addLayer(conv6);
    ...
    ConvolutionLayer* conv7 = new ConvolutionLayer(100, "Conv7", norm6, {11,3,3,3}, 3); //output size: 3*100*257*257
    addLayer(conv7);
    ...
    SubTensorLayer* subTensor1 = new SubTensorLayer(110, "SubTensor1", branch1, {1,9,4,4},{3,100,257,257}); //output size: 3*100*257*257
    addLayer(subTensor1);
    ...
    MergerLayer* merger1 = new MergerLayer(120, "Merger1", {3,100,257,257}); //output size: 3*100*257*257
    addLayer(merger1);
    ...
    SoftmaxLayer* softmax1 = new SoftmaxLayer(140, "Softmax1",bias2); //output size: 3*100*257*257
    addLayer(softmax1);
    ...
    CrossEntropyLoss* crossEntropy1 = new CrossEntropyLoss(160, "CrossEntropy1", branch3);//output size: 3*100*257*257
